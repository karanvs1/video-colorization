...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--pwcnet_path",
        type=str,
        default="./trained_models/pwcNet-default.pytorch",
        help="the path that contains the pre-trained PWCNet model",
    )
    parser.add_argument(
        "--perceptual_path",
        type=str,
    ...
    # GPU parameters
    parser.add_argument(
        "--multi_gpu", type=bool, default=False, help="True for more than 1 GPU, we recommend to use 4 NVIDIA Tesla v100 GPUs"
    )
    ...
    parser.add_argument(
        "--epoch_overhead", type=int, default=300, help="overhead for lr decrease / saving on different resolutions (trained epochs)"
    )  # change if fine-tune
    ...
    # dataset
    parser.add_argument("--baseroot", type=str, default="C:\\Users\\yzzha\\Desktop\\dataset\\1", help="color image baseroot")
    # ./ILSVRC2012_train
    # ./DAVIS_videvo_train
